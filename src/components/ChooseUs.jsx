                    ...
                    {accordionData.map((item) => (
                        <div key={item.id}>
                            ...
                            <h2>
                                <button
                                    type="button"
                                    className="flex md:items-center justify-between w-full py-5 font-medium text-n-5 border-b border-n-2 text-xl md:h5 mb-3 gap-3"
                            ...
                            >
                                <div className="py-5 ">
                                    <p className="body-1 text-n-4">{item.content}</p>
                                </div>
                            </div>
                        </div>
                    ))}

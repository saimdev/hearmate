  ...
  return (
    <div className="flex justify-between gap-[1rem] max-lg:flex-wrap">
      {pricing.map((item) => (
        <div
          key={item.id}
          className="w-full min-w-[20rem] max-lg:w-full max-h-full px-6 bg-n-1 border border-n-2 rounded-[2rem] lg:w-auto py-14  even:border-3  [&>h3]:first:text-color-2 [&>h3]:even:text-color-1 [&>h3]:last:text-color-4"
        >
